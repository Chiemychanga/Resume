  ...
  \resumeSubHeadingListStart
    ...
    \resumeItemListStart
      \resumeItem{Customer Service}
        {Connecting healthcare providers with language interpreters so they can treat all patients with the same superior quality care.}
    \resumeItemListEnd
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{Data Structure Programs Grader}
          {Using a grading ruberic from my manager, I troubleshooted student's C++ Data Structure programs using GDB and valgrind. I graded writing papers and code in this position. I always did my best to give the best feedback to students since I was once in this difficult class.}
      \resumeItemListEnd
